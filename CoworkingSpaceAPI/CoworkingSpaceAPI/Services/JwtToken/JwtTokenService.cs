// CoworkingSpaceAPI/Services/JwtTokenService.cs
using CoworkingSpaceAPI.Dtos.Auth.Request; // Import request DTOs for authentication
using CoworkingSpaceAPI.Dtos.Auth.Response; // Import response DTOs for authentication
using CoworkingSpaceAPI.Models; // Import user model
...
namespace CoworkingSpaceAPI.Services.JwtToken // Define the service namespace
{
