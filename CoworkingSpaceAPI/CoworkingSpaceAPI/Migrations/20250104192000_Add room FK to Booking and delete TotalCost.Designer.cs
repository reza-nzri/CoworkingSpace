...
namespace CoworkingSpaceAPI.Migrations
{
    ...
    [Migration("20250104192000_Add room FK to Booking and delete TotalCost")]
    partial class AddroomFKtoBookinganddeleteTotalCost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoworkingSpaceAPI.Models.AddressType", b =>
                {
                    ...
                    b.HasIndex(new[] { "AddressTypeName" }, "UQ__AddressT__071A958776CC882F")
                        .IsUnique()
